...
export function Layout() {
  ...
  return (
    <div className="w-screen min-h-screen bg-[#fefefe] dark:bg-zinc-800">
      <div className="sm:max-w-[1120px] sm:mx-auto sm:w-screen dark:bg-zinc-800">
        <Toaster />

        <header className="bg-white/25 dark:bg-zinc-800 z-40 backdrop-blur-md fixed top-0 left-0 right-0">
            ...
            <nav className="flex items-center">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="text-xs">{name || 'Nome do grupo'}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </nav>
