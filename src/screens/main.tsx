  ...
  return (
    ...
    >
      ...
      {/** <div className="flex flex-col items-start w-full mb-10">
        ...
        <span className="text-xs text-zinc-500 text-left dark:text-zinc-400 block mt-5">
      ...
      <div className="grid grid-cols-2 grid-rows-8 gap-2.5 min-w-full min-h-[70%]">
        <Link
          to="/ads"
          className="rounded flex items-start justify-center flex-col border hover:shadow-lg dark:border-zinc-700 transition-all duration-300 row-span-4 p-10"
        >
          <div className="p-5 mb-5 rounded-full bg-[#305a96]/20 dark:bg-[#305a96]/30">
        ...
        <Link
          ...
          className="rounded flex items-start justify-center flex-col border hover:shadow-lg dark:border-zinc-700 transition-all duration-300 row-span-4 p-10"
        >
          <div className="p-5 mb-5 rounded-full bg-yellow-500/20 dark:bg-yellow-500/30">
        ...
        <Link
          to="/info"
          className="rounded flex col-span-2 items-start justify-center flex-col border hover:shadow-lg dark:border-zinc-700 transition-all duration-300 row-span-4 p-10"
        >
          <div className="p-5 mb-5 rounded-full bg-green-500/20 dark:bg-green-500/20">
